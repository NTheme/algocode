...
sed -i "s|exec_res = os.path.join(BASE_DIR, 'db.sqlite3')|/home/algocode/db.sqlite3|" /app/configs/config_example.json
...
sed -i "s|configs/config.json|/home/algocode/config.json|" /app/algocode/settings.py
